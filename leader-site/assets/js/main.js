...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Service Carousel
        var swiperProject = new Swiper(".service-carousel-2", {
            slidesPerView: 1,
            spaceBetween: 24,
            loop: true,
            autoplay: true,
        ...
        var swiperHero = new Swiper(".hero-carousel", {
            ...
            speed: 1000,
            navigation: {
                nextEl: '.hero-carousel .swiper-prev',
                prevEl: '.hero-carousel .swiper-next',
            },
        });

        // Service Animation
        gsap.utils.toArray(".service-item-wrap .service-item").forEach((element, index, array) => {
